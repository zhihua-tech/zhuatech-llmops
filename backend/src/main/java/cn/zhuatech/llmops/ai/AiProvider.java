...
@Component class DemoAiProvider implements AiProvider { /**
                                                         * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
                                                         */
public AiResult execute(String prompt,Map<String,String> context){return new AiResult("demo-llmops-provider","已生成演示评测摘要，生产发布仍须通过质量、安全、时延和人工审批门禁。",Map.of("qualityScore",91.8,"safetyPassed",true,"gate","pending"));} }
